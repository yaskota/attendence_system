const sendPasswordTemp = (name, email, password) => {
    return `
    <div style="max-width: 600px; margin: auto; padding: 30px; 
        ...
        <h2 style="color: #25D366; margin-bottom: 10px;">Welcome to AMS</h2>
        <p style="color: #333; font-size: 16px; margin-bottom: 20px;">
            Hi <strong>${name}</strong>, your registered email is <strong>${email}</strong>.
        </p>

        <p style="color: #555; font-size: 15px;">
            Please use this password to login into your AMS account .
...
export default sendPasswordTemp;